class Component {
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="row" style="margin-top: 0.75rem; margin-bottom: 0.75rem">
                            ...
                            <div class="col-5">
                                <select name="jk_anak[]" class="form-select" id="jk_anak">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tmpt_lahir_anak[]"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pendidikan_anak[]"
                    ...
                    <div class="form-group">
                        ...
                        <select name="diserahkan_anak[]" style="margin-top: 0.75rem; margin-bottom: 0.75rem" class="form-select" id="diserahkan_anak">
                    ...
                    <div class="form-group">
                        ...
                        <select name="baptis_anak[]" style="margin-top: 0.75rem; margin-bottom: 0.75rem" class="form-select" id="baptis_anak">
                    ...
                    <div class="form-group">
                        ...
                        <select name="nikah_anak[]" style="margin-top: 0.75rem; margin-bottom: 0.75rem" class="form-select" id="nikah_anak">
    ...
    static tambahKeluarga = () => {
        ...
        <input type="hidden" name="keluarga[]" value="keluarga" id="keluarga">
            <div class="card">
                <div style="display: flex; justify-content: flex-end; padding: 0.75rem">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="row" style="margin-top: 0.75rem; margin-bottom: 0.75rem">
                            ...
                            <div class="col-5">
                                <select name="jk_keluarga[]" class="form-select" id="jk_keluarga">
                                    <option value="" hidden selected>Jenis Kelamin</option>
                                    <option value="L">Laki-Laki</option>
                                    <option value="P">Perempuan</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tmpt_lahir_keluarga[]"
                            style="margin-top: 0.75rem; margin-bottom: 0.75rem" id="tmpt_lahir_keluarga">
                    </div>
                    <div class="form-group">
                        <label for="tgl_lahir_keluarga">Tanggal Lahir *</label>
                        <input type="date" class="form-control" name="tgl_lahir_keluarga[]"
                    ...
                    <div class="form-group">
                        ...
                        <select name="diserahkan_keluarga[]" style="margin-top: 0.75rem; margin-bottom: 0.75rem" class="form-select" id="diserahkan_keluarga">
                            <option value="" hidden selected>Diserahkan</option>
                            <option value="Y">Iya</option>
                            <option value="T">Tidak</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="baptis_keluarga[]" style="margin-top: 0.75rem; margin-bottom: 0.75rem" class="form-select" id="baptis_keluarga">
                            <option value="" hidden selected>Baptis Selam</option>
                            <option value="Y">Iya</option>
                            <option value="T">Tidak</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="nikah_keluarga[]" style="margin-top: 0.75rem; margin-bottom: 0.75rem" class="form-select" id="nikah_keluarga">
                            <option value="" hidden selected>Nikah</option>
                            <option value="Y">Iya</option>
                            <option value="T">Tidak</option>
                        </select>
