...
<body>
    <form action="{{ route('handler.kkj.update', $data->id) }}" method="post">
        @csrf
        @method('patch')
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <label style="font-wight:bold"for="kecamatan">Kecamatan : {{ $data->kecamatan }}</label>
                            </div>
                            <div>
                                <label style="font-wight:bold"for="status_menikah">Status Menikah : {{ $data->status_menikah }}</label>
                            </div>
                        </div>
                    </div>
                    {{-- data anggota --}}
                    <div class="row" style="margin-top: 1.5rem">
                        {{-- kepala keluarga --}}
                        <div class="col-sm mb-3" id="card_kepala_keluarga">
                            <div class="card">
                                <div class="card-body">
                                    <p style="margin-bottom: 1.5rem; font-weight: 600; font-size: 14px">Kepala Keluarga</p>
                                    <div>
                                        <label style="font-wight:bold"for="nama_kepala_keluarga">Nama Lengkap : {{ $data->kepala_keluarga->nama }}</label>
                                    </div>
                                    <div class="div">
                                        <label style="font-wight:bold"for="nama_kepala_keluarga">Jenis Kelamin : {{  $data->kepala_keluarga->jk == "L"? "Laki Laki":"Perempuan" }}</label>
                                    </div>
                                    <div>
                                        <label style="font-wight:bold"for="tmpt_lahir">Tempat Lahir : {{ $data->kepala_keluarga->tmpt_lahir }}</label>
                                    </div>
                                    <div>
                                        <label style="font-wight:bold"for="tgl_lahir">Tanggal Lahir : {{ $data->kepala_keluarga->tgl_lahir }}</label>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <label for="foto_kk">Foto Kepala Keluarga</label>
                                        <div style="width: fit-content; margin: 0 auto">
                                            <img src="{{ asset('storage/'.$data->kepala_keluarga->foto) }}" alt="" style="width: 300px; height: 200px; object-fit: cover">
                                        </div>
                                    </div>
                                    <div>
                                        <label for="foto_kk">Foto Kartu Keluarga</label>
                                        <div style="width: fit-content; margin: 0 auto">
                                            <img src="{{ asset('storage/'.$data->kepala_keluarga->foto_kk) }}" alt="" style="width: 300px; height: 200px; object-fit: cover">
                                        </div>
                                    </div>
                                    <div>
                                        <label for="foto_kk">Foto Baptis</label>
                                        <div style="width: fit-content; margin: 0 auto">
                                            <img src="{{ asset('storage/'.$data->kepala_keluarga->foto_baptis) }}" alt="" style="width: 300px; height: 200px; object-fit: cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <label>Hubungan : {{ $keluarga->hubungan }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
