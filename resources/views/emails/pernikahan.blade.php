    ...
    <div>
        ...
        <div class="card" id="card_pria" style="margin-bottom: 1rem">
            <div class="card-body">
                ...
                <div id="pengantin_pria">
                    <p style="font-size: 18px;font-weight: 500">Pengantin Pria</p>
                    <div class="form-group">
                        <label for="nama_pria">Nama Pria : {{ $data->pengantin_pria->nama }}</label>
                    </div>
                    <div class="form-group">
                        <label for="">Hari, Tanggal Baptis Selam : {{ Carbon\Carbon::parse($data->pengantin_pria->waktu, 'Asia/Jakarta')->translatedFormat('l, d F Y H:i') }}</label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="tmpt_lahir_pria">Tempat Lahir : {{ $data->pengantin_pria->tmpt_lahir }}</label>
                    </div>
                    <div class="form-group">
                        <label for="tgl_lahir_pria">Tanggal Lahir : {{ Carbon\Carbon::parse($data->pengantin_pria->tgl_lahir, 'Asia/Jakarta')->translatedFormat('d F Y') }}</label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="nama_ayah_pria">Nama Ayah : {{ $data->pengantin_pria->nama_ayah }}</label>
                    </div>
                    <div class="form-group">
                        <label for="nama_ibu_pria">Nama Ibu : {{ $data->pengantin_pria->nama_ibu }}</label>
                    </div>
                </div>
            </div>
        </div>
        <div class="card" id="card_wanita" style="margin-bottom: 1rem">
            <div class="card-body">
                {{-- data wanita --}}
                <div id="pengantin_pria">
                    <p style="font-weight: 500; font-size: 18px">Pengantin Wanita</p>
                    <div class="form-group">
                        <label for="nama_pria">Nama Wanita : {{ $data->pengantin_wanita->nama }}</label>
                    </div>
                    <div class="form-group">
                        <label for="">Hari, Tanggal Baptis Selam : {{ Carbon\Carbon::parse($data->pengantin_wanita->waktu, 'Asia/Jakarta')->translatedFormat('l, d F Y H:i') }}</label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="tmpt_lahir_pria">Tempat Lahir : {{ $data->pengantin_wanita->tmpt_lahir }}</label>
                    </div>
                    <div class="form-group">
                        <label for="tgl_lahir_pria">Tanggal Lahir : {{ Carbon\Carbon::parse($data->pengantin_wanita->tgl_lahir, 'Asia/Jakarta')->translatedFormat('d F Y') }}</label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="nama_ayah_pria">Nama Ayah : {{ $data->pengantin_wanita->nama_ayah }}</label>
                    </div>
                    <div class="form-group">
                        <label for="nama_ibu_pria">Nama Ibu : {{ $data->pengantin_wanita->nama_ibu }}</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card" style="">
            ...
            <div class="card-body">
                <p style="font-size: 18px; font-weight: 500">Data Lainnya</p>
                <div class="form-group">
