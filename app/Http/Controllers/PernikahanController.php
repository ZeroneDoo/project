...
class PernikahanController extends Controller
{
    ...
    public function index()
    {
        ...
        if(Auth::user()->role->nama == "Admin Pernikahan") $datas = Pernikahan::with('pengantin', 'pengantin.anggota_keluarga')->where("cabang_id", Auth::user()->cabang_id)->where("status", "done")->paginate(4);
